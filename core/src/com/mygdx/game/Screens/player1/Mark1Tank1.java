...
public class Mark1Tank1 implements Screen {
    ...
    public Mark1Tank1(AP_Game game) {
        this.game = game;
        img = new Texture("Mark1Tank.png");
    ...
    public void show() {
        ...
        Button1.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new ToxicTank1(game));
            }
        });
    ...
    protected void  Choosebutton(){
        ...
        choosebutton.addListener(new ClickListener(){
            @Override
            public void clicked(InputEvent event, float x, float y) {
                game.setPlayer1TankName("Mark1Tank");
